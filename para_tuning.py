...
import gym_custom  # noqa: F401 pytype: disable=import-error
...
if __name__ == "__main__":
    train()
    # python para_tuning.py --algo sac --env module/ --log-folder para_tuning_results
    # python para_tuning.py --algo sac --env TrainEnvVariableStiffnessAndPosture-v7 --n-timesteps 50000 -optimize --n-trials 40 --n-jobs 4 --sampler tpe --pruner halving --env-kwargs task_name:"'cabinet surface with plan'"
