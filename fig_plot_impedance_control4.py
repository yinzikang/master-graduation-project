...
------------      -------    --------    -----------
4/26/23 9:57 PM   yinzikang      1.0         None
"""
import os
...
for step in range(rbt_controller_kwargs['step_num']):
    ...
    jk5_with_controller.render(pause_start=True)
    # if step > 0:
...
plt.figure(i)
plt.plot(pos_error1[:, 0], label='wx')
plt.plot(pos_error1[:, 1], label='wy')
plt.plot(pos_error1[:, 2], label='wz')
plt.plot(pos_error2[:, 0], label='tx')
plt.plot(pos_error2[:, 1], label='ty')
plt.plot(pos_error2[:, 2], label='tz')
plt.legend(loc='upper right')
plt.xlabel('steps')
...
plt.figure(i)
plt.plot(pos_error1_table[:, 0], label='wx')
plt.plot(pos_error1_table[:, 1], label='wy')
plt.plot(pos_error1_table[:, 2], label='wz')
plt.plot(pos_error2_table[:, 0], label='tx')
plt.plot(pos_error2_table[:, 1], label='ty')
plt.plot(pos_error2_table[:, 2], label='tz')
plt.legend(loc='upper right')
plt.xlabel('steps')
